...
Translation2d m_backRightLocation = new Translation2d(-0.381, -0.381);
  ...
  public void setSpeeds(ChassisSpeeds speeds) {
    ...
    System.out.println(speeds);
      this.speeds = speeds;
      drive(this.speeds.vxMetersPerSecond, this.speeds.vyMetersPerSecond, 0, false, false);
  }
 ...
 public double getDistance(){
  ...
  public void periodic() {
   ...
   SmartDashboard.putNumber("Note Sensor", getDistance());
  //  if (getDistance() < .1) {
  //       new ArmTopRow(arm);
  //       timer.start();
  //       if(timer.get() > 1) {
